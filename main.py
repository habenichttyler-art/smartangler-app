...
# --- HARDCODED STATEWIDE REGIONAL TELEMETRY MAP ---
...
def get_isolated_county_nodes(county):
    ...
    # 100% COMPLETE MASTER WATER MATRIX - VERIFIED NO MATH DRIFT ALLOWED
    master_water_matrix = {
        "Alachua": [
            {"name": "Newnans Lake - Main Channel Ledge", "lat": 29.6450, "lon": -82.2150, "depth": "4-8 ft"},
            {"name": "Newnans Lake - Northern Pad Flats", "lat": 29.6645, "lon": -82.2230, "depth": "3-6 ft"},
            {"name": "Lochloosa Lake - Public Dock Pass", "lat": 29.5085, "lon": -82.1795, "depth": "6-10 ft"},
            {"name": "Cross Creek - Mid-Stream Connection", "lat": 29.4855, "lon": -82.1645, "depth": "5-9 ft"},
        ...
        "Baker": [
            ...
            {"name": "St. Marys River - State Road 121 Spans", "lat": 30.4225, "lon": -82.1550, "depth": "5-8 ft"},
            {"name": "Ocean Pond - Public Fishing Pier Point", "lat": 30.2165, "lon": -82.4270, "depth": "5-9 ft"},
            {"name": "Ocean Pond - West Shore Launch Channel", "lat": 30.2110, "lon": -82.4435, "depth": "4-8 ft"},
            {"name": "St. Marys River - South Fork Bend", "lat": 30.2740, "lon": -82.2810, "depth": "4-6 ft"}
        ],
        "Bay": [
            {"name": "Russell-Fields Beach Pier - Open Deep Gulf", "lat": 30.2125, "lon": -85.8812, "depth": "12-18 ft"},
            {"name": "St. Andrews Pass - Shipping Channel Slot", "lat": 30.1265, "lon": -85.7342, "depth": "15-32 ft"},
            {"name": "Grand Lagoon - Navigation Bridge Cut", "lat": 30.1340, "lon": -85.7510, "depth": "8-16 ft"},
            {"name": "Carl Gray Park - Hathaway Bridge Pipeline", "lat": 30.1835, "lon": -85.7180, "depth": "6-14 ft"},
            {"name": "North Bay - Main Channel Drop Ledge", "lat": 30.2520, "lon": -85.6940, "depth": "7-13 ft"}
        ],
        "Bradford": [
            {"name": "Sampson Lake - Public Access Ramp Pool", "lat": 29.9225, "lon": -82.1985, "depth": "4-8 ft"},
            {"name": "Sampson Lake - Deep Basin Hole Center", "lat": 29.9275, "lon": -82.1910, "depth": "6-11 ft"},
            {"name": "Lake Crosby - Launch Basin Entry Slough", "lat": 29.9540, "lon": -82.1480, "depth": "4-7 ft"},
            {"name": "Lake Crosby - Northeast Spawning Shore", "lat": 29.9590, "lon": -82.1410, "depth": "3-6 ft"},
            {"name": "Alligator Creek - Central Pool Flow Cut", "lat": 29.9450, "lon": -82.1120, "depth": "3-5 ft"}
        ],
        "Brevard": [
            {"name": "Eau Gallie Bridge - Main Causeway Spans", "lat": 28.1278, "lon": -80.6150, "depth": "6-12 ft"},
            {"name": "Melbourne Causeway - Relief Channel Fender", "lat": 28.0784, "lon": -80.5920, "depth": "8-15 ft"},
            {"name": "Max Brewer Pier - Public Catwalk Grid", "lat": 28.6253, "lon": -80.7940, "depth": "5-10 ft"},
            {"name": "Sebastian Inlet State Park - Ocean Jetty Base", "lat": 27.8605, "lon": -80.4440, "depth": "10-24 ft"},
            {"name": "Pineda Causeway - Intracostal Channel Slot", "lat": 28.2085, "lon": -80.6650, "depth": "6-11 ft"}
        ],
        "Broward": [
            {"name": "Port Everglades - Deep Entry Shipping Track", "lat": 26.1150, "lon": -80.1110, "depth": "15-35 ft"},
            {"name": "Dania Beach Pier - Ocean Piling Matrix", "lat": 26.0385, "lon": -80.1105, "depth": "10-18 ft"},
            {"name": "Everglades Conservation Area - Main L-67 Canal", "lat": 26.0610, "lon": -80.4440, "depth": "8-14 ft"},
            {"name": "Everglades Holiday Park - South Loop Waterway", "lat": 26.0550, "lon": -80.4550, "depth": "6-12 ft"},
            {"name": "Hillsboro Inlet - Bridge Support Fender", "lat": 26.2560, "lon": -80.0810, "depth": "8-16 ft"}
        ],
        "Calhoun": [
            {"name": "Apalachicola River - Blountstown Center Cut", "lat": 30.4312, "lon": -85.0413, "depth": "8-16 ft"},
            {"name": "Apalachicola River - Route 20 Bridge Support", "lat": 30.4390, "lon": -85.0390, "depth": "10-22 ft"},
            {"name": "Chipola River - Dead Lakes Main Launch Pool", "lat": 30.1380, "lon": -85.1120, "depth": "5-10 ft"},
            {"name": "Chipola River - Limestone Shoal Deep Wall", "lat": 30.2240, "lon": -85.1450, "depth": "4-9 ft"},
            {"name": "Apalachicola River - Ocheesee Oxbow Junction", "lat": 30.3450, "lon": -85.0110, "depth": "6-12 ft"}
        ],
        "Charlotte": [
            {"name": "El Jobean Pier - Myakka River Bridge Spans", "lat": 26.9630, "lon": -82.2110, "depth": "6-11 ft"},
            {"name": "Placida Harbor - Cape Haze Grass Flat Trench", "lat": 26.8320, "lon": -82.2640, "depth": "4-8 ft"},
            {"name": "Gasparilla Pass - Outer Tidal Inlet Pass", "lat": 26.7190, "lon": -82.2610, "depth": "10-22 ft"},
            {"name": "Stump Pass - Barrier Island Approach Channel", "lat": 26.9010, "lon": -82.3680, "depth": "5-12 ft"},
            {"name": "Peace River Estuary - Punta Gorda Channel Edge", "lat": 26.9342, "lon": -82.0514, "depth": "6-14 ft"}
        ],
        "Citrus": [
            {"name": "Crystal River - Main Channel Ledge Cut", "lat": 28.8933, "lon": -82.6055, "depth": "8-14 ft"},
            {"name": "Fort Island Gulf Beach - Public Catwalk End", "lat": 28.9161, "lon": -82.6922, "depth": "4-6 ft"},
            {"name": "Lake Henderson - Inverness Boat Ramp Pool", "lat": 28.8392, "lon": -82.3215, "depth": "5-10 ft"},
            {"name": "Homosassa River - Deep Limestone River Trench", "lat": 28.7994, "lon": -82.6210, "depth": "6-12 ft"},
            {"name": "Withlacoochee River - Yankeetown Delta Mouth", "lat": 29.0012, "lon": -82.7215, "depth": "4-9 ft"}
        ],
        "Clay": [
        ...
        "Dixie": [
            {"name": "Suwannee River - Mud Creek Marsh Outflow", "lat": 29.3240, "lon": -83.1310, "depth": "5-10 ft"},
        ...
        "Hernando": [
            ...
            {"name": "Withlacoochee River - Deep Limestone Ledge", "lat": 28.6150, "lon": -82.2220, "depth": "10-24 ft"},
        ...
        "Walton": [
            ...
            {"name": "Coastal Dune Lake - Coastal Inflow Barrier Outflow Pool", "lat": 30.3310, "lon": -86.1450, "depth": "4-8 ft"},
